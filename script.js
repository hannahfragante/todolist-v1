...
function addTodo(e) {
    ...
    if (todoInput.value === "") {
        ...
        addTodoLocally(todoInput.value);
    }
...
function getTodos() {
    //CHECK if you already have todos locally
    let todos;
...
function deleteTodoLocally(todo) {
    //CHECK if you already have todos locally
    let todos;
    if (localStorage.getItem("todos") === null) {
        todos = [];
